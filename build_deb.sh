...
#   /usr/lib/kubuno/modules/tasks/{kubuno-tasks, module.toml, frontend/}
#   /usr/share/kubuno/modules/tasks/migrations/*.sql
#   /etc/kubuno/modules/tasks/config.toml.example
#
# Usage :
